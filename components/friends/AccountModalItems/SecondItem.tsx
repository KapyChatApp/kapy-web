    ...
    <div className="flex flex-col items-start justify-start gap-3 w-full h-fit">
      ...
      <div className="flex flex-row gap-[54px] w-full h-fit justify-start items-center">
        <div className="flex flex-col gap-3 w-fit h-fit items-start justify-center">
          <p className="text-dark-100 text-opacity-50 dark:text-light-900 dark:text-opacity-60 body-regular lg:paragraph-15-regular">
            Bio:
          </p>
          <p className="text-dark-100 text-opacity-50 dark:text-light-900 dark:text-opacity-60 body-regular lg:paragraph-15-regular">
            Birth date:
        ...
        <div className="flex flex-col gap-3 w-fit h-fit items-start justify-center">
          <p className="text-dark-100 text-opacity-80 dark:text-light-900 dark:text-opacity-80 body-regular lg:paragraph-15-regular">
            {user.bio}
          </p>
          <p className="text-dark-100 text-opacity-80 dark:text-light-900 dark:text-opacity-80 body-regular lg:paragraph-15-regular">
